...
@__app_environment_variables_v_1.3 = internal constant [37 x i8] c"f60458c6-eae6-4520-8924-186df6f5a05a\00", align 16
...
@__ApplicationConfig_android_package_name.0 = internal constant [29 x i8] c"com.companyname.releasecrash\00", align 16
...
@__DSOCacheEntry_name.52 = internal constant [27 x i8] c"libaot-ReleaseCrash.dll.so\00", align 16
...
@dso_cache = local_unnamed_addr global [464 x %struct.DSOCacheEntry] [
	...
	; 65
	%struct.DSOCacheEntry {
		i64 2860869855894367242, ; hash 0x27b3d9f9f534ec0a, from name: aot-ReleaseCrash
		i8 0, ; ignore
	...
	; 105
	%struct.DSOCacheEntry {
		i64 4275986527538326725, ; hash 0x3b575b1776472cc5, from name: aot-ReleaseCrash.dll.so
		i8 0, ; ignore
		i8* getelementptr inbounds ([27 x i8], [27 x i8]* @__DSOCacheEntry_name.52, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	...
	; 183
	%struct.DSOCacheEntry {
		i64 7991639557450494703, ; hash 0x6ee801d602cbf2ef, from name: ReleaseCrash
		i8 0, ; ignore
		i8* getelementptr inbounds ([27 x i8], [27 x i8]* @__DSOCacheEntry_name.52, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	...
	; 306
	%struct.DSOCacheEntry {
		i64 12541993688161053000, ; hash 0xae0e1ccf1e07e948, from name: ReleaseCrash.dll.so
		i8 0, ; ignore
		i8* getelementptr inbounds ([27 x i8], [27 x i8]* @__DSOCacheEntry_name.52, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	...
	; 356
	%struct.DSOCacheEntry {
		i64 14138387633635382813, ; hash 0xc435a4a4f79cd61d, from name: libaot-ReleaseCrash
		i8 0, ; ignore
		i8* getelementptr inbounds ([27 x i8], [27 x i8]* @__DSOCacheEntry_name.52, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	...
	; 394
	%struct.DSOCacheEntry {
		i64 15686790564644516559, ; hash 0xd9b2ace80795f2cf, from name: libaot-ReleaseCrash.dll.so
		i8 0, ; ignore
		i8* getelementptr inbounds ([27 x i8], [27 x i8]* @__DSOCacheEntry_name.52, i32 0, i32 0), ; name
		i8* null; handle
	}, 
